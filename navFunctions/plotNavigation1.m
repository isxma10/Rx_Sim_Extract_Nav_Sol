function plotNavigation1(navSolutions, satSolutions, SampleTime, satno)
...
%% Set reference position the average postion =============================
...
%% Plot all figures =======================================================
    ...
    for satNR = 1:NoSats
        skyPlot(handles(3, 2), ...
        satSolutions(satNR).az, ...
        satSolutions(satNR).el, ...
        satSolutions(satNR).PRN);
    hold on
    end
